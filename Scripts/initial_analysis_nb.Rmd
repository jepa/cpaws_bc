...
nsb_species <- my_path("D","Species","nsb_species.csv", read = T)
...
nsb_matching_species <- nsb_species %>% 
  filter(scientific_name %in% exploited_species$taxon_name) %>% 
  write_csv(my_path("D","Species",name ="nsb_dbem_matching_spp.csv"))
